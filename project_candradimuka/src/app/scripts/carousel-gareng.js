...
const GarengCarousel = () => {
  ...
  const pages = [
    ...
    <div key="0" className="flex items-center justify-center w-full h-full">
      ...
      >Reference</p>
      <img className="position-absolute w-[35%] mb-[35%]"
        src='/res_img/WIPS/gareng_ref.png'
        alt="Frame"
      />
    </div>,
    ...
    >Early Designs</p>
    <img className="position-absolute w-[16%] mb-[37%]"
      src='/res_img/WIPS/gareng_lineart.png'
      alt="Frame"
    />
  </div>,
...
// Sillhoutte
  ...
  >Colored</p>
  <img className="position-absolute w-[13%] mb-[35%]"
    src='/res_img/WIPS/gareng_color.png'
    alt="Frame"
  />
</div>,
// Sketch
  <div key="3" className="flex items-center justify-center w-full h-full">
    ...
    >Human Sketch</p>
    <img className="position-absolute w-[37%] mb-[35%]"
      src='/res_img/WIPS/gareng_sketch.png'
      alt="Frame"
    />
  </div>,
  ];
