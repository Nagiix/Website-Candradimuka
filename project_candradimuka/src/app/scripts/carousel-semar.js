  ...
  const pages = [
    ...
    <div key="0" className="flex items-center justify-center w-full h-full">
      <img 
        ...
        className="position-absolute w-[37%] h-[15%] ml-[0%] mb-[0%]" style={{
      }}/>
      ...
      <img className="position-absolute w-[55%] mb-[35%]"
        src='/res_img/WIPS/semar_ref.png'
        alt="Frame"
      />
    </div>,
    ...
    >Early Designs</p>
    <img className="position-absolute w-[45%] mb-[40%]"
      src='/res_img/WIPS/semar_total.png'
      alt="Frame"
    />
  </div>,
...
// Sillhoutte
  ...
  >Sillhoutte</p>
  <img className="position-absolute w-[55%] mb-[35%]"
    src='/res_img/WIPS/semar_sill.png'
    alt="Frame"
  />
</div>,
// Sketch
  <div key="3" className="flex items-center justify-center w-full h-full">
    ...
    >Human Sketch</p>
    <img className="position-absolute w-[25%] mb-[35%]"
      src='/res_img/WIPS/semar_sketch.png'
      alt="Frame"
    />
  </div>,
  ];
