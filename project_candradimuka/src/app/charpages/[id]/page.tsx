"use client"
import SemarCarousel from "../../scripts/carousel-semar"
import React from "react";

export default function CharPages({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (id === "Semar") {
    ...
    <SemarCarousel/>
    <div className="position-absolute w-100vw h-20vh bottom-[-7vw] left-[2%]">    
        <img
        className="w-[1790]"
    ...
    <div className="FooterWIP position-absolute">
        <img
        className="imgfooter_steamwip"
        src="/res_img/Icons/steam.png"
        />
        <img
        className="imgfooter_itchwip"
        src="/res_img/Icons/itch.png"
        />
        <h1 className="playnowwip">
        Play Now!
        </h1>

        <p className="Copyrightwip">Copyright © 2024 — Dimas Nauli Satria Addin Sinaga - 2401010179. All Rights Reserved</p>

    </div>
    </>);

  } else if (id === "2") {
    return <div>Page for ID 2</div>;
  } else {
    return <div>Default Page for other IDs</div>;
  }
}